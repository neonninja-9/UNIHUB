...
import { generateTeachingStrategies, GenerateTeachingStrategiesInput } from "@/ai/flows/generate-teaching-strategies";
import { z } from "zod";
  ...
  if (!validatedFields.success) {
    ...
    return {
      ...
      fields: {
        ...
        classPerformanceData: formData.get("classPerformanceData")?.toString() ?? "",
      },
