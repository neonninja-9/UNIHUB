...
export function Schedule({ courses }: ScheduleProps) {
  return (
    <div className="bg-[#1A1F3A] dark:bg-white rounded-xl p-6 shadow-lg dark:shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
      <h3 className="text-xl font-bold mb-2 text-white dark:text-[#1f2937]">Class Schedule</h3>
      <div className="text-sm text-gray-400 dark:text-[#6b7280] mb-4">Today</div>
          ...
          return (
            <div key={course.id} className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-300 dark:text-[#6b7280]">{course.name.toUpperCase()}</div>
